...
particlesJS("particles-js", {
    particles: {
        ...
        opacity: { value: 0.01, random: false, anim: { enable: false, speed: 0.05, opacity_min: 0.1, sync: false } },
        size: { value: 2, random: true, anim: { enable: false, speed: 40, size_min: 0.1, sync: false } },
        line_linked: { enable: true, distance: 150, color: "#181818", opacity: 0.4, width: 1 },
